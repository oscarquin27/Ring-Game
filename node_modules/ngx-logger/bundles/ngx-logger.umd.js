(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('rxjs/operators'), require('vlq'), require('rxjs'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define('ngx-logger', ['exports', '@angular/core', '@angular/common/http', 'rxjs/operators', 'vlq', 'rxjs', '@angular/common'], factory) :
	(factory((global['ngx-logger'] = {}),global.ng.core,global.ng.common.http,global.Rx.Observable.prototype,global.vlq,global.rxjs,global.ng.common));
}(this, (function (exports,core,http,operators,vlq,rxjs,common) { 'use strict';
...
var NGXMapperService = /** @class */ (function () {
    ...
    NGXMapperService.prototype._getSourceMap = function (sourceMapLocation, distPosition) {
        ...
        return this.httpBackend.handle(req).pipe(operators.filter(function (e) { return (e instanceof http.HttpResponse); }), operators.map(function (httpResponse) { return httpResponse.body; }), operators.map(function (sourceMap) {
