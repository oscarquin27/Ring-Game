...
import { HttpBackend, HttpRequest, HttpResponse, HttpHeaders, HttpParams } from '@angular/common/http';
import { filter, map, catchError, retry, switchMap } from 'rxjs/operators';
...
var NGXLoggerHttpService = /** @class */ (function () {
    ...
    NGXLoggerHttpService.prototype.logOnServer = function (url, log, options) {
        ...
        return this.httpBackend.handle(req).pipe(filter(function (e) { return e instanceof HttpResponse; }), map(function (httpResponse) { return httpResponse.body; }));
    };
...
var NGXMapperService = /** @class */ (function () {
    ...
    NGXMapperService.getStackLine = function () {
        var error = new Error();
        try {
            throw error;
        }
    ...
    NGXMapperService.getMapping = function (sourceMap, position) {
        ...
        for (var lineIndex = 0; lineIndex < lines.length; lineIndex++) {
            ...
            for (var columnIndex = 0; columnIndex < columns.length; columnIndex++) {
                var decodedSection = decode(columns[columnIndex]);
    ...
    NGXMapperService.prototype._getSourceMap = function (sourceMapLocation, distPosition) {
        ...
        return this.httpBackend.handle(req).pipe(filter(function (e) { return (e instanceof HttpResponse); }), map(function (httpResponse) { return httpResponse.body; }), map(function (sourceMap) {
    ...
    NGXMapperService.prototype.getCallerDetails = function (sourceMapsEnabled) {
        var _this = this;
...
var NGXLogger = /** @class */ (function () {
    function NGXLogger(mapperService, httpService, loggerConfig, platformId) {
    ...
    NGXLogger.prototype._log = function (level, message, additional, logOnServer) {
        ...
        this.mapperService.getCallerDetails(config.enableSourceMaps).subscribe(function (callerDetails) {
            var logObject = {
                message: message,
...
var CustomNGXLoggerService = /** @class */ (function () {
    function CustomNGXLoggerService(mapperService, httpService, platformId) {
        this.mapperService = mapperService;
        this.httpService = httpService;
        this.platformId = platformId;
    }
    CustomNGXLoggerService.prototype.create = function (config, httpService, logMonitor, mapperService) {
        var logger = new NGXLogger(mapperService || this.mapperService, httpService || this.httpService, config, this.platformId);
        if (logMonitor) {
...
export { LoggerModule, Levels, NGXLogger, LoggerConfig, CustomNGXLoggerService, NGXLoggerMonitor, NGXLoggerHttpService, NGXMapperService, NGXLoggerUtils, NgxLoggerLevel, NGXLogInterface, NGXLoggerMock, CustomNGXLoggerServiceMock, NGXLoggerHttpServiceMock, LoggerTestingModule };
