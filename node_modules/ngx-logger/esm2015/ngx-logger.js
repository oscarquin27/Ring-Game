...
class NGXMapperService {
    ...
    _getSourceMap(sourceMapLocation, distPosition) {
        ...
        return this.httpBackend.handle(req).pipe(filter(e => (e instanceof HttpResponse)), map((httpResponse) => httpResponse.body), map(sourceMap => {
...
class NGXLogger {
     ...
     * @param {?} platformId
     */
    constructor(mapperService, httpService, loggerConfig, platformId) {
...
class CustomNGXLoggerService {
     ...
     * @param {?} platformId
     */
    constructor(mapperService, httpService, platformId) {
        this.mapperService = mapperService;
        this.httpService = httpService;
        this.platformId = platformId;
    }
    ...
    create(config, httpService, logMonitor, mapperService) {
        ...
        /** @type {?} */
        const logger = new NGXLogger(mapperService || this.mapperService, httpService || this.httpService, config, this.platformId);
        if (logMonitor) {
